---
title: "Cucumber: Multi-Environment Latin Square Field Experiment"
author: "Kar Ng"
date: "7/13/2021"
output: 
  html_document: 
...
![](C:\Users\karho\Desktop\R and Stats\R for online presence\20210713_p8_MultiEnv - Lartin Square Design\Multi-Latin\pic3_thumbnail.png)

***

```{r echo=FALSE}
bytes <- file.size("multi_latin.Rmd")
words <- bytes/10
minutes <- words/200
```
...
![](C:\Users\karho\Desktop\R and Stats\R for online presence\20210713_p8_MultiEnv - Lartin Square Design\Multi-Latin\pic6_combined.png)
...
* 6) There is one additional column needs to be removed: "**int64_field_0**".


<br/>

![](C:\Users\karho\Desktop\R and Stats\R for online presence\20210713_p8_MultiEnv - Lartin Square Design\Multi-Latin\pic1_sql.JPG)
...
<br/>
![](C:\Users\karho\Desktop\R and Stats\R for online presence\20210713_p8_MultiEnv - Lartin Square Design\Multi-Latin\pic2_sql2.JPG)
<br/>
...
![](C:\Users\karho\Desktop\R and Stats\R for online presence\20210713_p8_MultiEnv - Lartin Square Design\Multi-Latin\pic4_posthoc.JPG)
...
2. Q-Q plot to test for the overall residual normality, all points are forming a line, close to the straight line, and are falling within the 95% confidence interval. For this result, I conclude that the residuals in the entire dataset are normally distributed. Q-Q plot does the same test as Shapiro-Wilk test, both are used to test residual normality but in respective way. 
...
3. Levene's test is carried out to test for variance homogeneity. The result shows a P-value of 0.9667, which is higher than 0.05, and concludes that variances in the dataset are homogeneous. 
...
![](C:\Users\karho\Desktop\R and Stats\R for online presence\20210713_p8_MultiEnv - Lartin Square Design\Multi-Latin\pic5_finalstat.JPG)
...
William Bridges (1989). Analysis of a plant breeding experiment with heterogeneous variances
using mixed model equations. Applications of mixed models in agriculture and related disciplines,
S. Coop. Ser. Bull, 45–51.